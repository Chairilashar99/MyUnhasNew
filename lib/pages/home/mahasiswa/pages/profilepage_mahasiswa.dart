...
class ProfilepageMahasiswa extends StatelessWidget {
  final ProfileMahasiswaController controller =
      Get.put(ProfileMahasiswaController());

  ProfilepageMahasiswa({Key? key}) : super(key: key);
          ...
          Padding(
            ...
            child: Column(
              children: [
                InkWellContainer(
                  onTap: () {
                    Get.toNamed('/personal-data-mahasiswa');
                  },
                ...
                InkWellContainer(
                  onTap: () {
                    Get.toNamed('/change-password-mahasiswa');
                  },
                  padding: const EdgeInsets.symmetric(vertical: 6),
                  color: Colors.white,
                  radius: 8.0,
