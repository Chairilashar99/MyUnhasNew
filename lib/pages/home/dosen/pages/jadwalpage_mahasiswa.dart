...
class JadwalPageDosen extends StatefulWidget {
  const JadwalPageDosen({super.key});

  @override
  State<JadwalPageDosen> createState() => _JadwalPageDosenState();
}

class _JadwalPageDosenState extends State<JadwalPageDosen> {
